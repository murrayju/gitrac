...
createdBy: web
updated: '2026-03-30T01:32:59.027Z'
---
...
![image.png](/api/issues/assets/erK6448tbTkMl6FwN4xcM.png)
...
Fix:
- Created src/core/assets.ts with extractAssetRefs() — pure function that scans markdown for /api/issues/assets/<filename> patterns and returns unique filenames
